...
def generate_launch_description():
    ...
    if ros_domain_id == '51':
        parameters_file_name = 'dual_ekf-real-1-blue.yaml'
    elif ros_domain_id == '52':
        parameters_file_name = 'dual_ekf-real-2-blue.yaml'
    elif ros_domain_id == '53':
        parameters_file_name = 'dual_ekf-real-3-blue.yaml'
    elif ros_domain_id == '54':
        parameters_file_name = 'dual_ekf-real-4-blue.yaml'
    elif ros_domain_id == '61':
        parameters_file_name = 'dual_ekf-real-11-blue.yaml'
    elif ros_domain_id == '62':
        parameters_file_name = 'dual_ekf-real-12-blue.yaml'
    elif ros_domain_id == '63':
        parameters_file_name = 'dual_ekf-real-13-blue.yaml'
    elif ros_domain_id == '64':
        parameters_file_name = 'dual_ekf-real-14-blue.yaml'
    else:
        parameters_file_name = 'dual_ekf-real.yaml'
